...
public class Group1Thread implements Runnable {
	 ...
	 * Array of words containing each word on that line.  It then compares
	 * each word in the line with the collection targetWords.  If a target
	 * words is found it adds its name to the queue for the corresponding
	 * Group 2 thread.
	 * 
